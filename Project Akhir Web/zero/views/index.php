...
<body>
    <div class="bungkus">
        <section>
            ...
            <nav>
                <!--- logo --->
                <button onclick="showPopup()"<a href="biodatapribadi.html" class="logo">SleepWell Hotel</a> </button>
                ...
                <script>
                    ...
                    <!--- menu --->
                    <ul>
                        <li><a href="halamanlogin.html">Home</a></li>
                        <li><a href="biodata.html" class="active">Destinasi</a></li>
                        <li><a href="pesann.html">Pesan</a></li>
                        <a href="halamanlogin.html"><button><i class="fa fa-sign-out-alt"></i></button></a>
            ...
            <div class="text-container">
                ...
                Ayok pesan hotel yang nyaman</p> -->
                    <a href="dokumentasi.html"><button class="hire-btn">Lihat Hotel</button></a>
