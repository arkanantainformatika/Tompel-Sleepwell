<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM adminku");
    $adminku = [];
...
<head>
    ...
    <title>Dashboard - Data Hotel</title>
...
<body>
    <div class="dashboard">
        <nav class="dash-side-bar">
            ...
            <ul>
                <li>Data Hotel</li>
                <li><a href="adminpage_pemesanan.php" class="pesanan">Data Pemesanan</a></li>
                <li>Item 3</li>
                <li>Item 4</li>
            </ul>
            <div class="settings">
        ...
        <main class="dash-container">
            ...
            <section class="dash-main">
                ...
                <div class="leading-btn">
                    <a href="add_data_hotel.php"><button class="add-btn">Tambah</button></a>
                </div><br>
                <table>
                    <thead>
                        <tr>
